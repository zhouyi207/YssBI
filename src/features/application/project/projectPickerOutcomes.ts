import { IPC_MALFORMED_ERROR_CODE, IPC_TRANSPORT_FAILURE_CODE } from "@/shared/constants/ipcError";
import {
...
export function projectPickerErrorPresentation(error: unknown): ProjectPickerErrorPresentation {
