...
export type EditorSessionUi = ReturnType<typeof useEditorUIState> & ReturnType<typeof useEditorUIActions>;
...
export function useOptionalEditorSessionUi(enabled: boolean): EditorSessionUi {
  ...
  return useMemo(() => ({ contextMenu, detailFocus, ...uiActions }), [contextMenu, detailFocus, uiActions]);
}
