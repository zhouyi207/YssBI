...
export type EditorSessionDetailActionsSlice = Pick<EditorSessionVariableActions, "updateVariable"> &
...
export type EditorCanvasResourcesSlice = Pick<EditorSessionResourcesSlice, "variables">;
...
export function pickEditorSessionLayoutBindings(
