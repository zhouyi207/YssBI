...
describe('useEditorKeyboard', () => {
  ...
  it.each([{ ctrlKey: true }, { metaKey: true }])(
    ...
    (modifier) => {
      ...
      expect(callbacks.selectAllNodes).toHaveBeenCalledWith(expect.objectContaining({
        panelInstanceId: 'editor-a',
        groupId: 'group-a',
        resourceRef: 'events/main.yssbi-event',
      }));
  ...
  it('routes only plain F and plain Home through the physical editor target', () => {
    ...
    expect(callbacks.focusSelectedNodes).toHaveBeenCalledWith(expect.objectContaining({
      panelInstanceId: 'editor-a',
    }));
    expect(callbacks.fitCompleteGraph).toHaveBeenCalledWith(expect.objectContaining({
      panelInstanceId: 'editor-a',
    }));
