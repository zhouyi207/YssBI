...
export function readEditorPartOptions(): EditorPartOptions {
  ...
  return {
    openSideBySideDirection:
      editor.openSideBySideDirection ?? DEFAULT_EDITOR_PART_OPTIONS.openSideBySideDirection,
    splitOnDragAndDrop: editor.splitOnDragAndDrop ?? DEFAULT_EDITOR_PART_OPTIONS.splitOnDragAndDrop,
    alwaysShowEditorActions:
      editor.alwaysShowEditorActions ?? DEFAULT_EDITOR_PART_OPTIONS.alwaysShowEditorActions,
