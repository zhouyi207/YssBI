...
export interface LogsDockviewLayoutController {
...
export function createLogsDockviewLayoutController(
  ...
  const controller: LogsDockviewLayoutController = {
    bind(api) {
...
export const logsDockviewLayoutController = createLogsDockviewLayoutController();
