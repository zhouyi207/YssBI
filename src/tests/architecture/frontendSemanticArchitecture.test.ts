...
import { FRONTEND_ASSET_DEPENDENCY_POLICY } from "./frontendAssetDependencyPolicy";
...
import { FRONTEND_EXTERNAL_DEPENDENCY_POLICY } from "./frontendExternalDependencyPolicy";
...
describe("frontend semantic architecture", () => {
  it("reports stable frontend semantic boundary rules", () => {
    withIsolatedTypeScriptProject(fixtureSources, (context) => {
      ...
      expect(
        ...
        },
        {
          ...
          dependencyKind: "static-import",
          canonicalOriginTarget:
            "src/features/core/fixture/projectionPublisher.ts::projectionPublisher",
        },
        {
    ...
    withIsolatedTypeScriptProject(
      ...
      (context) => {
        expect(() =>
          auditFrontendSemantics(context, productionTypeScriptSources(context), fixturePolicy),
        ).toThrowError(
