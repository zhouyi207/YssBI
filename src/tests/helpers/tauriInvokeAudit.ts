...
function isTauriCoreImport(binding: ts.ImportSpecifier | ts.NamespaceImport): boolean {
...
export function isTauriInvokeCall(
  ...
  return (
    ...
    symbolHasTauriNamespaceImport(checker.getSymbolAtLocation(expression.expression), project)
  );
}
