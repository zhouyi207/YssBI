...
import { sortAndFilterProjects, type ProjectSortMode } from "./projectPickerViewUtils";
...
export function ProjectPickerScreen() {
  ...
  const pageIssueCanRetry =
    pageIssue != null && (pageIssue.kind === "failure" || pageIssue.operation === "scan");

  const contextMenuSections = useMemo(
    () =>
      buildProjectPickerContextMenuSections(
        contextMenu,
        {
