      ...
      >
        {filteredProjects.length === 0 ? (
          <Empty className="h-full min-h-[12rem] rounded-none px-6">
            <EmptyHeader>
              <EmptyMedia variant="icon" className="size-12 border border-[var(--strong-border)] bg-[var(--surface-raised)] text-[var(--accent-color)] shadow-sm">
            ...
            <EmptyContent className="flex-row justify-center">
              {projects.length === 0 ? (
                <>
                  ...
                  <Button type="button" variant="outline" onClick={onImportProject} disabled={isBusy}>
                    <VscFolderOpened />
              ...
              {filteredProjects.map((project) => {
                ...
                return (
                  <li key={project.id} className="relative min-w-0">
                    ...
                    >
                      {isFavorite ? <VscStarFull size={16} className="text-amber-400" /> : <VscStarEmpty size={16} />}
                    </ToolbarIconButton>
                    <ToolbarIconButton
                      type="button"
                      variant="ghost"
