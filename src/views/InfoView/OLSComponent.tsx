...
import { hypothesisTest, computeAcfPacf, computeSerialTests } from '@/services/stats';
import type { HypothesisTestResponse } from '@/services/stats';
import type { AcfPacfResponse, SerialTestsResponse } from '@/services/stats';
...
function ACFPACFBlock({ residuals }: { residuals?: number[] }) {
...
function SerialTestsBlock({ residuals, exog }: { residuals?: number[]; exog?: number[][] }) {
  const [lag, setLag] = useState(20);
