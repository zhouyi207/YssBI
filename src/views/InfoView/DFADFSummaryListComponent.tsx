                ...
                >
                  <TableCell className={infoStatsCellClass}>
                    <div className="flex items-center gap-2">
                      <div
                        className={`h-1.5 w-1.5 rounded-full ${reject ? "bg-emerald-400" : "bg-muted-foreground/40"}`}
                      />
                      <span
                        className={`font-mono font-medium ${reject ? "text-foreground" : "text-muted-foreground"}`}
                      >
                        {item.regression}
                      </span>
                    </div>
                  ...
                  <TableCell className={infoStatsCellRightClass}>
                    {cons ? (
                      <>
                        <span
                          className={
                            cons.p_value < 0.05 ? "text-emerald-400" : "text-muted-foreground"
                          }
                        >
                  ...
                  <TableCell className={infoStatsCellRightClass}>
                    {trend ? (
                      <>
                        <span
                          className={
                            trend.p_value < 0.05 ? "text-emerald-400" : "text-muted-foreground"
                          }
                        >
