      ...
      <div className="mb-6">
        ...
        <div className="flex items-center gap-3 flex-wrap">
          ...
          {diag.ivliml_kappa != null && (
            <span className="inline-flex items-center px-2 py-0.5 rounded text-[10px] font-medium bg-gray-700/50 text-gray-300 border border-gray-600/50">
            ...
            <div className="rounded-lg border border-gray-800/50 overflow-hidden">
              <div className="px-4 py-2.5 bg-[#1a1d23] border-b border-gray-800/50 flex items-center justify-between">
                ...
                {diag.iv2sls_first_stage_summary.min_eigenvalue_cv && (
                  <span className="text-[10px] text-gray-500">Stock-Yogo (2005) LIML</span>
                )}
              </div>
              {diag.iv2sls_first_stage_summary.min_eigenvalue_cv && (() => {
                  ...
                  <div className="rounded-lg border border-gray-800/50 bg-[#1a1d23] px-4 py-3 hover:border-gray-700/50 transition-colors">
                    ...
                    <div className="flex flex-wrap items-baseline gap-x-4 gap-y-1 text-xs">
                      <span className="text-gray-400">
                        chi2 = <span className="font-mono text-white">{formatNum(diag.ivliml_overid.anderson_rubin_stat)}</span>
                      </span>
                      <span className="text-gray-400">
                        df = <span className="font-mono text-gray-300">{diag.ivliml_overid.df}</span>
                      </span>
                      <span className="text-gray-400">
                        p = <span className={`font-mono ${diag.ivliml_overid.anderson_rubin_p_value < 0.05 ? 'text-emerald-400' : 'text-gray-400'}`}>{formatNum(diag.ivliml_overid.anderson_rubin_p_value)}</span>
                      </span>
                    </div>
                    <div className="mt-1.5 text-[10px]">
                      {diag.ivliml_overid.anderson_rubin_p_value < 0.05 ? (
                        ...
                        <span className="text-gray-500">Do not reject H0 — overidentifying restrictions appear valid</span>
                      )}
                    </div>
                  </div>
                  <div className="rounded-lg border border-gray-800/50 bg-[#1a1d23] px-4 py-3 hover:border-gray-700/50 transition-colors">
                    ...
                    <div className="flex flex-wrap items-baseline gap-x-4 gap-y-1 text-xs">
                      <span className="text-gray-400">
                        F = <span className="font-mono text-white">{formatNum(diag.ivliml_overid.basmann_stat)}</span>
                      </span>
                      <span className="text-gray-400">
                        p = <span className={`font-mono ${diag.ivliml_overid.basmann_p_value < 0.05 ? 'text-emerald-400' : 'text-gray-400'}`}>{formatNum(diag.ivliml_overid.basmann_p_value)}</span>
                      </span>
                    </div>
                    <div className="mt-1.5 text-[10px]">
