        ...
        {diag.iv2sls_overid ? (
          <>
            ...
            <p className="mt-2 px-1 text-xs text-muted-foreground">
              H0: overidentifying restrictions are valid. Significant p-value suggests instruments
              may not be valid.
              {diag.iv2sls_overid.test_type === "wooldridge" &&
          ...
          <div className="rounded-lg border border-amber-500/30 bg-amber-500/10 px-4 py-3">
            ...
            <p className="mt-1 text-xs text-muted-foreground">
              ...
              endogenous variables). Exogenous variables are not counted as instruments.
            </p>
          </div>
        )}
      </div>
              ...
              <div className="rounded-lg border border-border bg-muted px-4 py-3 transition-colors hover:border-border">
                ...
                <div className="flex flex-wrap items-baseline gap-x-4 gap-y-1 text-xs">
                  <span className="text-muted-foreground">
                    F ={" "}
                    <span className="font-mono text-foreground">
                      {formatNum(diag.ivliml_overid.basmann_stat)}
                    </span>
                  </span>
                  <span className="text-muted-foreground">
                    p ={" "}
  ...
  return (
    <ReportSection title="Tests of Endogeneity" icon="endogeneity">
      <div className="mb-4">
              ...
              <div className="rounded-lg border border-border bg-muted px-4 py-3 transition-colors hover:border-border">
                ...
                <div className="flex flex-wrap items-baseline gap-x-4 gap-y-1 text-xs">
                  <span className="text-muted-foreground">
                    ...
                    <span className="font-mono text-foreground">
                      {formatNum(diag.iv2sls_endogenous.durbin_stat)}
                    </span>
                  </span>
                  <span className="text-muted-foreground">
                    p ={" "}
              ...
              <div className="rounded-lg border border-border bg-muted px-4 py-3 transition-colors hover:border-border">
                ...
                <div className="flex flex-wrap items-baseline gap-x-4 gap-y-1 text-xs">
                  <span className="text-muted-foreground">
                    ...
                    <span className="font-mono text-foreground">
                      {formatNum(diag.iv2sls_endogenous.wu_stat)}
                    </span>
                  </span>
                  <span className="text-muted-foreground">
                    p ={" "}
            ...
            <div className="rounded-lg border border-border bg-muted px-4 py-3 transition-colors hover:border-border">
              ...
              <div className="flex flex-wrap items-baseline gap-x-4 gap-y-1 text-xs">
                <span className="text-muted-foreground">
                  ...
                  <span className="font-mono text-foreground">
                    {formatNum(diag.iv2sls_hausman.stat)}
                  </span>
                </span>
                <span className="text-muted-foreground">
                  p ={" "}
        ...
        <p className="mt-2 px-1 text-xs text-muted-foreground">
          estat endogenous: Durbin &amp; Wu-Hausman. hausman iv ols, constant sigmamore: traditional
          Hausman. Significant p-value favors IV.
        </p>
      </div>
    </ReportSection>
  );
...
export function IvReportSections({
  ...
  return (
    <>
      ...
      {firstStage && firstStage.length > 0 ? (
        <IvFirstStageResultsSection firstStage={firstStage} />
      ) : null}
      ...
      {variant === "2sls" ? (
        <Iv2slsOveridSection diag={diag} />
      ) : (
        <IvLimlOveridSection diag={diag} />
      )}
