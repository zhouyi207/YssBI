...
function activateDiagnostic(row: GraphNodeDiagnostic, focused: FocusedGraphSession | null): void {
...
export function DiagnosticsPanel() {
  ...
  const rows = useMemo(() => collectNodeDiagnostics(graphPath ?? "", bucket), [bucket, graphPath]);
