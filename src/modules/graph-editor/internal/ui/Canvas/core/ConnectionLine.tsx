...
import { subscribeToViewport, getViewport } from "@/features/core/viewport/viewportSession";
...
export const ConnectionLine = ({
  ...
  useEffect(() => {
    getCanvasLocalPointRef.current = getCanvasLocalPoint;
  }, [getCanvasLocalPoint]);
  useEffect(() => {
    themeTokensRef.current = tokens;
  }, [tokens]);
  useEffect(() => {
