export const enUS = {
  ...
  projectPicker: {
    ...
    description: "Continue from recent projects, or create / open a project file.",
    ...
    emptyDescription: "Open an existing .json project or create an empty project to show it here.",
    ...
    localOnlyHint: "This list is stored locally in the frontend and does not delete project files from disk.",
