...
export async function createNodeInBackend(
    ...
    try {
        ...
        console.log('[createNodeInBackend] Creating node:', {
            subgraphId,
            nodeId: node.id,
            nodeType: node.type
        });
        ...
        console.log('[createNodeInBackend] Node created successfully:', result);
...
export async function deleteNodeInBackend(
    ...
    try {
        console.log('[deleteNodeInBackend] Deleting node:', {
            subgraphId,
            nodeId
        });
