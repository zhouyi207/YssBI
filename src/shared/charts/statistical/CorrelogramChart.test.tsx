...
describe('CorrelogramChart', () => {
  it('renders report bars without Ljung-Box fields', () => {
    ...
    const bars = [...host.querySelectorAll<SVGRectElement>(
      '[data-chart-mark="correlogram-bar"]',
    )];
  ...
  it('exposes Plot statistics and updates supplied CI references with stable joins', () => {
    ...
    const bar = host.querySelector<SVGRectElement>(
      '[data-chart-mark="correlogram-bar"]',
    );
    ...
    const region = host.querySelector<SVGRectElement>(
      '[data-chart-region="confidence"]',
    );
    ...
    expect.soft(paintOrder.indexOf(recoveredZero as Element))
