...
function isDiagnosticLocation(value: unknown): value is DiagnosticLocationDto {
  ...
  switch (value.kind) {
    ...
    case "connection":
      return (
        hasExactKeys(value, ["kind", "connectionId"]) && typeof value.connectionId === "string"
      );
    case "parameter":
      return (
        hasExactKeys(value, ["kind", "nodeId", "key"]) &&
  ...
  return (
    ...
    value.fields.every(
      (field) =>
        ...
        ["boolean", "int64", "float64", "string", "date", "dateTime", "unknown"].includes(
          field.scalarType as string,
        ),
    )
  );
}
  ...
  return (
    ...
    (value.input === null ||
      (isRecord(value.input) &&
        ...
        ["connections", "literal", "protocolDefault", "unbound"].includes(
          value.input.effective as string,
        ))) &&
...
function isParameterConfiguration(value: unknown): boolean {
  ...
  if (value.kind === "projectColumns") {
    return (
      hasExactKeys(value, ["kind", "available", "unavailableReason", "options", "value"]) &&
