...
export type PinDataTypeDefinition = { Concrete: DataType } | { TypeVar: string } | "Unknown";
...
export type PinRoleDTO = { Exec: ExecRoleDTO } | { Data: DataRoleDTO };
...
export type PinSlot =
  ...
  | {
      ...
      sourceRole: PinRoleDTO;
      direction: PinDirection;
      baseType: PinDataTypeDefinition;
    };
