...
function computationSettingsResult(overrides: Record<string, unknown> = {}): Record<string, unknown> {
  return {
...
describe('ProjectService computation settings', () => {
  ...
  it.each([
    ...
    ['non-finite tolerance', () => {
      const value = computationSettingsResult();
      const numeric = (value.settings as Record<string, unknown>).numeric as Record<string, unknown>;
    ...
    ['unknown missing-value policy', () => {
      const value = computationSettingsResult();
      const missing = (value.settings as Record<string, unknown>).missingValues as Record<string, unknown>;
  ...
  it('strictly parses a correlated update receipt and sends one revisioned request', async () => {
    ...
    await expect(ProjectService.updateProjectComputationSettings({
      projectInstanceId: 'project-a',
