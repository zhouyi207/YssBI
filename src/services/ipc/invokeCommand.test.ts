...
describe('IPC error wire contract', () => {
  ...
  it.each([
    ...
    ['legacy message', { code: 'internal_error', details: null, incidentId: null, message: 'legacy' }],
...
describe('invokeCommand', () => {
  ...
  it.each([
    ...
    ['almost structured rejection', { code: 'internal_error', details: null, incidentId: null, extra: true }],
