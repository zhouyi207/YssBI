...
autocorrelation retain their existing numerical implementations.

The reader uses a private Tokio runtime with a deadline and serial admission, and handles callers
already inside Tokio without nesting runtimes. It has no Tauri, Project or Application authority.
