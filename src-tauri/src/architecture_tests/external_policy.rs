...
const RUST_EXTERNAL_DECLARATIONS: &[ExternalDependencyDeclarationAllowance] = &[
    ...
    ExternalDependencyDeclarationAllowance {
        owning_package: "yss-harness-contract",
        mode: RustDependencyMode::Runtime,
        package_name: "serde_json",
        target_condition: None,
    },
    ...
    ExternalDependencyDeclarationAllowance {
        owning_package: "yss-database-source",
        mode: RustDependencyMode::Runtime,
        package_name: "futures-util",
        target_condition: None,
    },
    ExternalDependencyDeclarationAllowance {
        owning_package: "yss-database-engine",
        mode: RustDependencyMode::Runtime,
        package_name: "url",
        target_condition: None,
    },
    ExternalDependencyDeclarationAllowance {
        owning_package: "yss-database-store",
        mode: RustDependencyMode::Runtime,
        package_name: "arrow",
        target_condition: None,
    },
    ...
    ExternalDependencyDeclarationAllowance {
        owning_package: "yss-database-arrow",
        mode: RustDependencyMode::Runtime,
        package_name: "arrow",
        target_condition: None,
    },
    ...
    ExternalDependencyDeclarationAllowance {
        owning_package: "yss-harness-core",
        mode: RustDependencyMode::Runtime,
        package_name: "thiserror",
        target_condition: None,
    },
    ExternalDependencyDeclarationAllowance {
        owning_package: "yss-harness-sqlite",
        mode: RustDependencyMode::Runtime,
        package_name: "serde",
        target_condition: None,
    },
    ...
    ExternalDependencyDeclarationAllowance {
        owning_package: "yss-bayes-result",
        mode: RustDependencyMode::Runtime,
        package_name: "serde",
        target_condition: None,
    },
    ...
    ExternalDependencyDeclarationAllowance {
        owning_package: "yss-graph-analysis",
        mode: RustDependencyMode::Runtime,
        package_name: "serde",
        target_condition: None,
    },
    ...
    ExternalDependencyDeclarationAllowance {
        owning_package: "yss-graph-analysis-contract",
        mode: RustDependencyMode::Runtime,
        package_name: "serde",
        target_condition: None,
    },
    ...
    ExternalDependencyDeclarationAllowance {
        owning_package: "yss-graph-document-edit",
        mode: RustDependencyMode::Runtime,
        package_name: "serde",
        target_condition: None,
    },
    ...
    ExternalDependencyDeclarationAllowance {
        owning_package: "yss-graph-runtime",
        mode: RustDependencyMode::Runtime,
        package_name: "thiserror",
        target_condition: None,
    },
    ExternalDependencyDeclarationAllowance {
        owning_package: "yss-graph-type-mapping",
        mode: RustDependencyMode::Runtime,
        package_name: "thiserror",
        target_condition: None,
    },
    ExternalDependencyDeclarationAllowance {
        owning_package: "yss-julia-runtime",
        mode: RustDependencyMode::Runtime,
        package_name: "serde",
        target_condition: None,
    },
    ...
    ExternalDependencyDeclarationAllowance {
        owning_package: "yss-resource-lifecycle",
        mode: RustDependencyMode::Runtime,
        package_name: "thiserror",
        target_condition: None,
    },
    ...
    ExternalDependencyDeclarationAllowance {
        owning_package: "yss-project-identity",
        mode: RustDependencyMode::Runtime,
        package_name: "serde",
        target_condition: None,
    },
    ...
    ExternalDependencyDeclarationAllowance {
        owning_package: "yss-project-registry-contract",
        mode: RustDependencyMode::Runtime,
        package_name: "serde",
        target_condition: None,
    },
    ...
    ExternalDependencyDeclarationAllowance {
        owning_package: "yss-project-registry-sqlite",
        mode: RustDependencyMode::Runtime,
        package_name: "sqlx",
        target_condition: None,
    },
