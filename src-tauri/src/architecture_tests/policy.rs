...
const EXACT_SOURCE_MEMBERSHIP: &[(&str, RustLayer)] = &[
    ...
    ("src-tauri/src/harness.rs", RustLayer::CompositionRoot),
    ("src-tauri/src/projects.rs", RustLayer::CompositionRoot),
    (
...
const RUST_INTERNAL_CAPABILITIES: &[InternalDependencyCapability] = &[
    ...
    InternalDependencyCapability {
        source_layer: RustLayer::CompositionRoot,
        repository_relative_source_file: "src-tauri/src/harness.rs",
        fully_qualified_owner: "yssbi_lib::harness",
        canonical_origin_targets: &[
            "yss_application::execution::session_slot::ApplicationState",
            ...
            "yss_ipc_channel::harness::HarnessChannelHub::new",
            "yss_ipc_channel::harness_graph::HarnessGraphClientHub::new",
        ],
    },
    InternalDependencyCapability {
        source_layer: RustLayer::CompositionRoot,
        repository_relative_source_file: "src-tauri/src/projects.rs",
        fully_qualified_owner: "yssbi_lib::projects",
        canonical_origin_targets: &[
        ...
        .filter_map(|dependency| {
            ...
            let crosses_scientific_boundary = (package_name == "yss-linalg"
                ...
                || (package_name == "yss-sci-runtime"
                    && !matches!(
                        dependency.owning_package.as_str(),
                        "yss-sci-runtime" | "yss-graph-execution" | "yss-ipc-command"
                    ))
