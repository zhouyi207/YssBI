...
const RUST_INTERNAL_CAPABILITIES: &[InternalDependencyCapability] = &[
    ...
    InternalDependencyCapability {
        ...
        canonical_origin_targets: &[
            ...
            "yss_api::graph_projection_runtime::GraphProjectionRuntime::initialize",
    ...
    InternalDependencyCapability {
        ...
        canonical_origin_targets: &[
            ...
            "yss_api::schema::graph_draft::GraphDraftAcceptedDto",
            "yss_api::schema::graph_draft::GraphEditorSessionDto",
            "yss_api::schema::graph_draft::GraphProjectionRequestDto",
            "yss_api::schema::graph_draft::compile_graph_draft_to_transport",
            "yss_api::schema::graph_draft::graph_draft_accepted_to_transport",
    ...
    InternalDependencyCapability {
        source_layer: RustLayer::Commands,
        repository_relative_source_file: "src-tauri/crates/yss-api/src/commands/command_node_system/projections.rs",
        fully_qualified_owner: "yss_api::commands::command_node_system::projections",
        canonical_origin_targets: &[
            "yss_api::error::CommandError",
            "yss_api::schema::graph_projection_channel::GraphProjectionChannelEventDto",
            "yss_api::schema::graph_projection_channel::GraphProjectionSnapshotDto",
            "yss_api::schema::graph_projection_channel::GraphProjectionSubscriptionDto",
            "yss_application::execution::session_slot::ApplicationState",
        ],
    },
    InternalDependencyCapability {
        source_layer: RustLayer::Commands,
        repository_relative_source_file: "src-tauri/crates/yss-api/src/graph_projection_runtime.rs",
        fully_qualified_owner: "yss_api::graph_projection_runtime",
        canonical_origin_targets: &[
            "yss_api::schema::application_event::graph_projection_replacement_to_transport",
            "yss_api::schema::graph_projection_channel::GraphProjectionChannelEventDto",
            "yss_api::schema::graph_projection_channel::GraphProjectionPublicationDto",
            "yss_api::schema::graph_projection_channel::GraphProjectionPublicationKey",
            "yss_api::schema::graph_projection_channel::GraphProjectionSnapshotDto",
            "yss_api::schema::graph_projection_channel::GraphProjectionSubscriptionDto",
            "yss_application::execution::session_slot::ApplicationState",
        ],
    ...
    InternalDependencyCapability {
        ...
        canonical_origin_targets: &[
            ...
            "yss_application::editor_projection::model::EditorParameterValueSource",
    ...
    InternalDependencyCapability {
        ...
        canonical_origin_targets: &[
            ...
            "yss_application::resource_mutation::GraphDraftAccepted",
            "yss_graph_document_edit::patch::GraphDocumentPatch",
            "yss_project_history::HistoryStatusDto",
        ],
    },
