...
mod tests {
    ...
    fn test_add_node_chained_calculation() {
        ...
        let mut add1_ctx = crate::execution::GraphExecutionContext::new(graph.clone(), add1_node);
        ...
        let mut add2_ctx = crate::execution::GraphExecutionContext::new(graph.clone(), add2_node);
        ...
        let mut add3_ctx = crate::execution::GraphExecutionContext::new(graph.clone(), add3_node);
