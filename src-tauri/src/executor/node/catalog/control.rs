...
pub fn register(registry: &NodeRegistry) {
    ...
    while_loop.add_input(GenericInDataPin::new(uuid::Uuid::nil(), "Condition", "bool"));
    while_loop.add_input(GenericInDataPin::new(uuid::Uuid::nil(), "MaxIterations", "number"));
    ...
    for_loop.add_input(GenericInDataPin::new(uuid::Uuid::nil(), "Start", "number"));
    for_loop.add_input(GenericInDataPin::new(uuid::Uuid::nil(), "End", "number"));
    for_loop.add_input(GenericInDataPin::new(uuid::Uuid::nil(), "Step", "number"));
