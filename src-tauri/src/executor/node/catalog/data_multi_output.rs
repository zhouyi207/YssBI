...
pub fn register(registry: &NodeRegistry) {
    ...
    // ============================================================================
    {
        ...
        node.add_in_data_pin(GenericInDataPin::new(uuid::Uuid::nil(), "Object", PinTypeDesc::concrete(ValueType::Struct(vec![]))));
        node.add_out_data_pin(GenericOutDataPin::new(uuid::Uuid::nil(), "Keys", PinTypeDesc::concrete(ValueType::List(Box::new(ValueType::Any)))));
        node.add_out_data_pin(GenericOutDataPin::new(uuid::Uuid::nil(), "Values", PinTypeDesc::concrete(ValueType::List(Box::new(ValueType::Any)))));
    ...
    // ============================================================================
    {
        ...
        node.add_out_data_pin(GenericOutDataPin::new(uuid::Uuid::nil(), "First", PinTypeDesc::concrete(ValueType::Any)));
        node.add_out_data_pin(GenericOutDataPin::new(uuid::Uuid::nil(), "Last", PinTypeDesc::concrete(ValueType::Any)));
    ...
    // ============================================================================
    {
        ...
        node.add_in_data_pin(GenericInDataPin::new(uuid::Uuid::nil(), "Array", PinTypeDesc::concrete(ValueType::List(Box::new(ValueType::Any)))));
        node.add_in_data_pin(GenericInDataPin::new(uuid::Uuid::nil(), "Index", PinTypeDesc::concrete(ValueType::Float64)));
        node.add_out_data_pin(GenericOutDataPin::new(uuid::Uuid::nil(), "Before", PinTypeDesc::concrete(ValueType::List(Box::new(ValueType::Any)))));
        node.add_out_data_pin(GenericOutDataPin::new(uuid::Uuid::nil(), "After", PinTypeDesc::concrete(ValueType::List(Box::new(ValueType::Any)))));
        node.add_out_data_pin(GenericOutDataPin::new(uuid::Uuid::nil(), "AtIndex", PinTypeDesc::concrete(ValueType::Any)));
    ...
    // ============================================================================
    {
        ...
        node.add_in_data_pin(GenericInDataPin::new(uuid::Uuid::nil(), "Array", PinTypeDesc::concrete(ValueType::List(Box::new(ValueType::Any)))));
        node.add_in_data_pin(GenericInDataPin::new(uuid::Uuid::nil(), "Threshold", PinTypeDesc::concrete(ValueType::Float64)));
        node.add_out_data_pin(GenericOutDataPin::new(uuid::Uuid::nil(), "Above", PinTypeDesc::concrete(ValueType::List(Box::new(ValueType::Any)))));
        node.add_out_data_pin(GenericOutDataPin::new(uuid::Uuid::nil(), "Below", PinTypeDesc::concrete(ValueType::List(Box::new(ValueType::Any)))));
        node.add_out_data_pin(GenericOutDataPin::new(uuid::Uuid::nil(), "Equal", PinTypeDesc::concrete(ValueType::List(Box::new(ValueType::Any)))));
    ...
    // ============================================================================
    {
        ...
        node.add_in_data_pin(GenericInDataPin::new(uuid::Uuid::nil(), "Timestamp", PinTypeDesc::concrete(ValueType::Float64)));
        node.add_out_data_pin(GenericOutDataPin::new(uuid::Uuid::nil(), "Year", PinTypeDesc::concrete(ValueType::Float64)));
        node.add_out_data_pin(GenericOutDataPin::new(uuid::Uuid::nil(), "Month", PinTypeDesc::concrete(ValueType::Float64)));
        node.add_out_data_pin(GenericOutDataPin::new(uuid::Uuid::nil(), "Day", PinTypeDesc::concrete(ValueType::Float64)));
        node.add_out_data_pin(GenericOutDataPin::new(uuid::Uuid::nil(), "Hour", PinTypeDesc::concrete(ValueType::Float64)));
        node.add_out_data_pin(GenericOutDataPin::new(uuid::Uuid::nil(), "Minute", PinTypeDesc::concrete(ValueType::Float64)));
        node.add_out_data_pin(GenericOutDataPin::new(uuid::Uuid::nil(), "Second", PinTypeDesc::concrete(ValueType::Float64)));
