...
/// 根据目标类型转换值
fn convert_to_type(from_value: DataValue, to_type: &ValueType) -> Result<DataValue, String> {
    match to_type {
        ValueType::Boolean => convert_to_boolean(from_value),
        ValueType::Int32 => convert_to_int32(from_value),
        ValueType::Int64 => convert_to_int64(from_value),
        ValueType::Float32 => convert_to_float32(from_value),
        ValueType::Float64 => convert_to_float64(from_value),
        ValueType::String => convert_to_string_value(from_value),
