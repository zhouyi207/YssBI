...
pub(super) const NODES: &[NodeSpec] = &[
    ...
    spec(
        ...
        "Concatenate Columns",
        "按列拼接",
        &["concat columns", "horizontal concat"],
        &["按列拼接", "横向拼接"],
    ...
    spec(
        ...
        "Drop Columns",
        "移除列",
        &["drop columns", "remove columns", "exclude columns"],
        &["移除列", "删除列", "排除列"],
    ...
    spec(
        ...
        "Drop Rows",
        "移除行",
        &["drop rows", "remove rows", "exclude rows"],
        &["移除行", "删除行", "排除行"],
    ...
    spec(
        ...
        "Drop NA Rows",
        "删除缺失行",
        &["dropna", "drop null rows", "missing rows"],
        &["删除缺失行", "空值", "缺失值"],
    ...
    spec(
        ...
        "Drop NA Columns",
        "删除缺失列",
        &["dropna", "drop null columns", "missing columns"],
        &["删除缺失列", "空列", "缺失值"],
