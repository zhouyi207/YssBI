...
use crate::catalog_query::capture_localized_project_facts;
...
pub enum ExecutionApplicationError {
    ...
    GraphPackage(#[source] crate::graph_contracts::GraphPackageMappingError),
...
mod tests {
    use super::*;
    use crate::execution::ApplicationSessionEpoch;
