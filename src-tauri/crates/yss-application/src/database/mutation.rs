...
use crate::session::{ApplicationState, SessionRevalidationError};
...
pub(super) struct DatabaseMutationRequest {
    database: DatabaseId,
...
impl DatabaseMutationRequest {
    ...
    pub(super) const fn expected_runtime_revision(&self) -> u64 {
        self.expected_runtime_revision
    }
}

#[derive(Debug)]
pub(super) struct PreparedProjectDatabaseMutation {
    database: DatabaseId,
    expected_runtime_revision: u64,
...
impl PreparedProjectDatabaseMutation {
    ...
    pub(super) fn from_project_authority(
        database: DatabaseId,
        expected_runtime_revision: u64,
    ...
    pub(super) fn take_project_authority(
        mut self,
    ) -> Option<(
        DatabaseId,
        u64,
...
pub(super) enum ProjectDatabaseMutationError {
...
#[derive(Debug, Error)]
pub(super) enum ProjectDatabaseFinalizeError {
...
#[derive(Debug)]
pub(super) struct ProjectDatabaseMutationReceipt {
...
impl ProjectDatabaseMutationReceipt {
    ...
    pub(super) fn mutation(&self) -> &CommittedResourceMutation {
        &self.mutation
    }
}

pub(super) trait ProjectDatabaseMutationPort: Send + Sync {
    fn prepare(
        &self,
...
pub(super) struct UnresolvedDatabaseCompensation {
    database: DatabaseId,
...
#[derive(Debug, Error)]
pub(super) enum DatabaseMutationRecovery {
...
#[derive(Debug, Error)]
pub(super) enum DatabaseMutationApplicationError {
...
pub(super) fn mutate_database_in_captured_session(
    state: &ApplicationState,
    captured: &Arc<crate::session::ApplicationSession>,
    request: DatabaseMutationRequest,
