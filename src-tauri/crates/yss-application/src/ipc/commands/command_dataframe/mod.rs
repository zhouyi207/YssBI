use crate::database::samples::{SampleCatalog, SampleError, SampleImportError};
use crate::database::{
...
fn database_mutation_to_transport<T>(
    ...
    ResourceMutationCommandResultDto {
        data: result.data,
        mutation: crate::ipc::schema::application_event::resource_mutation_to_transport(
            &result.mutation,
        ),
    }
}
...
fn load_database_result_to_transport(
    ...
    ResourceMutationCommandResultDto {
        data: LoadDatabaseResultDto {
            ...
            columns: crate::ipc::schema::column_info_from_schema(&data.columns),
        },
        mutation: crate::ipc::schema::application_event::resource_mutation_to_transport(
            &result.mutation,
        ),
