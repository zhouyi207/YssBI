...
const definitionCount = [...source.matchAll(/message_key: "diagnostics\.graph\./gu)].length;
if (Object.keys(messages).length !== definitionCount) {
  throw new Error("Diagnostic generator did not parse every graph definition");
}
