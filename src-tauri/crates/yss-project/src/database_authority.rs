...
#[derive(Clone, Debug)]
pub struct DatabaseAuthorityToken {
...
struct DatabaseDeltaPublication<'a> {
    id: &'a str,
...
impl ProjectState {
    pub fn reserve_database_operation(
        &self,
    ...
    pub fn prepare_database_mutation_authority(
        &self,
        project_instance_id: &ProjectInstanceId,
        id: &str,
    ...
    pub fn commit_database_declaration_update(
        &self,
        project_instance_id: &ProjectInstanceId,
        token: DatabaseAuthorityToken,
        after: DatabaseDecl,
        operation_id: yss_project_identity::OperationId,
    ) -> Result<crate::project_writers::ProjectResourceMutationFacts, ProjectDatabaseError> {
        let session = self.validate_database_project_identity(project_instance_id)?;
    ...
    fn publish_database_delta(
        ...
        delta: DatabaseDeltaPublication<'_>,
    ) -> crate::project_writers::ProjectResourceMutationFacts {
        use yss_project_history::{
            DatabaseDocumentPatch, DatabaseResourceKey, ResourceDeltaEvent, ResourceDocumentPatch,
            ResourceKey,
        };

        let DatabaseDeltaPublication {
            id,
            from_revision,
            to_revision,
            operation_id,
    ...
    pub fn commit_database_declaration_add(
        &self,
        project_instance_id: &ProjectInstanceId,
        after: DatabaseDecl,
        operation_id: yss_project_identity::OperationId,
    ...
    pub fn commit_database_declaration_delete(
        &self,
        project_instance_id: &ProjectInstanceId,
        id: &str,
        expected_revision: yss_project_identity::ResourceRevision,
