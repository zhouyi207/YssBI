...
fn bp_stat_stata(g: &Col<f64>, z_matrix: &yss_sci_linalg::Mat<f64>) -> Result<(f64, usize), String> {
...
fn bp_stat_koenker(
    g: &Col<f64>,
    z_matrix: &yss_sci_linalg::Mat<f64>,
...
fn build_z_fitted(n: usize, fitted: &Col<f64>) -> yss_sci_linalg::Mat<f64> {
