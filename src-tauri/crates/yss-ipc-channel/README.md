...
Application-specific execution encoding and graph-client handoff live in [Application IPC channel adapters](../yss-application/src/ipc/channel/mod.rs). Graph preparation stays in Application use cases; the graph hub validates receipt identity and acknowledges adoption without creating a second draft store. Harness persistence, execution result authority and diagnostics history remain in their existing owners.
