...
fn dump_full() {
    ...
    println!(
        "stata: lm={:.15e} df={} p={:.15e}",
        bp_s.lm_stat, bp_s.df, bp_s.p_value
    );
    println!(
        "koenker: lm={:.15e} df={} p={:.15e}",
        bp_k.lm_stat, bp_k.df, bp_k.p_value
    );
    println!(
        "stata_rhs: lm={:.15e} df={} p={:.15e}",
        bp_sr.lm_stat, bp_sr.df, bp_sr.p_value
    );
    println!(
        "koenker_rhs: lm={:.15e} df={} p={:.15e}",
        bp_kr.lm_stat, bp_kr.df, bp_kr.p_value
    );

    println!("\n=== OLS IM-test ===");
    let im = diagnostics::im_test(&exog, &resid).unwrap();
    println!(
        "hetero: chi2={:.15e} df={} p={:.15e}",
        im.heteroskedasticity.chi2, im.heteroskedasticity.df, im.heteroskedasticity.p_value
    );
    println!(
        "skew: chi2={:.15e} df={} p={:.15e}",
        im.skewness.chi2, im.skewness.df, im.skewness.p_value
    );
    println!(
        "kurt: chi2={:.15e} df={} p={:.15e}",
        im.kurtosis.chi2, im.kurtosis.df, im.kurtosis.p_value
    );
    println!(
        "total: chi2={:.15e} df={} p={:.15e}",
        im.total.chi2, im.total.df, im.total.p_value
    );

    println!("\n=== OLS fitted[0..3] residual[0..3] ===");
    for i in 0..3 {
        println!(
            "fitted[{}]={:.15e} resid[{}]={:.15e}",
            i, fitted[i], i, resid[i]
        );
    }
    ...
    println!(
        "stata: lm={:.15e} df={} p={:.15e}",
        bp_ws.lm_stat, bp_ws.df, bp_ws.p_value
    );
    println!(
        "koenker: lm={:.15e} df={} p={:.15e}",
        bp_wk.lm_stat, bp_wk.df, bp_wk.p_value
    );
    println!(
        "stata_rhs: lm={:.15e} df={} p={:.15e}",
        bp_wsr.lm_stat, bp_wsr.df, bp_wsr.p_value
    );
    println!(
        "koenker_rhs: lm={:.15e} df={} p={:.15e}",
        bp_wkr.lm_stat, bp_wkr.df, bp_wkr.p_value
    );
    ...
    println!(
        "hetero: chi2={:.15e} df={} p={:.15e}",
        im_w.heteroskedasticity.chi2, im_w.heteroskedasticity.df, im_w.heteroskedasticity.p_value
    );
    println!(
        "skew: chi2={:.15e} df={} p={:.15e}",
        im_w.skewness.chi2, im_w.skewness.df, im_w.skewness.p_value
    );
    println!(
        "kurt: chi2={:.15e} df={} p={:.15e}",
        im_w.kurtosis.chi2, im_w.kurtosis.df, im_w.kurtosis.p_value
    );
    println!(
        "total: chi2={:.15e} df={} p={:.15e}",
        im_w.total.chi2, im_w.total.df, im_w.total.p_value
    );
