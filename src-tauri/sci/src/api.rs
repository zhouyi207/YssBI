...
pub mod regression {
    ...
    pub use crate::regression::linear_model::{
        ...
        IVLIMLResult, OLS, OLSConfig, OLSResult, Prais, PraisConfig, PraisResult, WLS,
        WLSConfig, WLSResult,
    };
    pub use crate::regression::panel::{
        ...
        fit_panel_re, fit_panel_re_be, fit_panel_re_be_time, fit_panel_re_fgls,
        fit_panel_re_fgls_time, fit_panel_re_fgls_twoway, fit_panel_re_mle,
